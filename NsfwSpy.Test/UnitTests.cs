...
public class UnitTests
{
    ...
    {
        var nsfwSpy = new NsfwSpy();
        Assert.Throws<ClassificationFailedException>(() => nsfwSpy.ClassifyImage([]));
    }

    [Theory]
    [InlineData("https://raw.githubusercontent.com/ptraced/NsfwSpy/main/NsfwSpy.Test/Assets/flower.jpg")]
    [InlineData("https://raw.githubusercontent.com/ptraced/NsfwSpy/main/NsfwSpy.Test/Assets/flower.png")]
    [InlineData("https://raw.githubusercontent.com/ptraced/NsfwSpy/main/NsfwSpy.Test/Assets/flower.webp")]
    ...
    [InlineData("https://raw.githubusercontent.com/ptraced/NsfwSpy/main/NsfwSpy.Test/Assets/flower.png")]
    [InlineData("https://raw.githubusercontent.com/ptraced/NsfwSpy/main/NsfwSpy.Test/Assets/flower.webp")]
    public void ClassifyImageUri_CustomHttpClient(string url)
    {
        var uri = new Uri(url);
        ...
        var nsfwSpy = new NsfwSpy();
        var result = nsfwSpy.ClassifyImage(uri, httpClient);
    ...
    [InlineData("https://raw.githubusercontent.com/ptraced/NsfwSpy/main/NsfwSpy.Test/Assets/flower.png")]
    [InlineData("https://raw.githubusercontent.com/ptraced/NsfwSpy/main/NsfwSpy.Test/Assets/flower.webp")]
    public async Task ClassifyImageUriAsync_CustomHttpClient(string url)
    {
        var uri = new Uri(url);
        var httpClient = new HttpClient();
        httpClient.DefaultRequestHeaders.Add("User-Agent", "test");
        ...
        var nsfwSpy = new NsfwSpy();
        var result = await nsfwSpy.ClassifyImageAsync(uri, httpClient);
